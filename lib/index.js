        ...
        bulkSync: function(existingCollection, desiredRows, columns, {noInsert, noUpdate, noDestroy} = {}) {
            ...
            return bookshelf.transaction((transacting) =>
              Promise.all([
                  ...
                  !noUpdate && results.updated.length ? this.bulkUpdate(results.updated, columns, { transacting, returnInserted: true, skipRead: true }) : [],
        ...
        bulkUpdate: function(rows, columns = [], { transacting, returnInserted, skipRead } = {}) {
          ...
          return Promise
            ...
            .then(existingRows => !skipRead? existingRows : rows.map(rowWithUpdates => {
              ...
              return rowMerged ? Object.assign(rowMerged, columns.length ? _.pick(rowWithUpdates, columns) : rowWithUpdates) : rowWithUpdates;
            }))
