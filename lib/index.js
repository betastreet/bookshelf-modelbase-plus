...
module.exports = (bookshelf) => {
    ...
    bookshelf.Model = bookshelf.Model.extend({
        ...
        bulkSync: function(existingCollection, desiredRows, columns, { transacting } = {}) {
            ...
            return this.transactionAsync(transacting)
                .then(transacting => Promise.all([
                  ...
                  results.updates.length ? this.bulkUpdate(results.updates, { transacting, returnInserted: true }) : null,
