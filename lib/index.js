    ...
    bookshelf.Model = bookshelf.Model.extend({
        ...
        createOne: function (options, createColumns) {
            return new Promise((resolve, reject) => {
                ...
                this
                    .create(data, { method: 'insert', autoRefresh: false })
                    .then((model) => {
                        if (model) {
            ...
            return new Promise((resolve, reject) => {
                ...
                this
                    ...
                    .then((model) => {
                        ...
                        return model
                            .save(toSave, { method: 'update', patch: true, require: true, autoRefresh: false });
                    })
                    .then((model) => {
                        return this.query({ where: findArgs }).fetch({ softDelete: false, require: true });
                    })
                    .then((model) => {
                    ...
                    return new Promise((resolveOne, rejectOne) => {
                        if (rowToImport.id) {
                            Model
                                ...
                                .fetch({ softDelete: false, require: false })
                                .then((existingModel) => {
                                    if (existingModel) {
                        ...
                        function create() {
                            ...
                            Model
                                .forge(rowToImport)
                                .save(null, { transacting: t, method: 'insert', autoRefresh: false })
                                .then((createdModel) => {
                                    rowCnt += 1;
                                    setImmediate(() => {
                        ...
                        function update(existingModel) {
                            ...
                            Model
                                ...
                                .save(toSave, { transacting: t, autoRefresh: false })
                                .then((updatedModel) => {
                                    rowCnt += 1;
                                    setImmediate(() => {
